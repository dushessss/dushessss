...
$arSection = CCache::CIblockSection_GetList(array("CACHE" => array("CACHE_GROUPS" => $arParams["CACHE_GROUPS"],"TAG" => CCache::GetIBlockCacheTag($arParams["IBLOCK_ID"]), "MULTI" => "N")), $arSectionFilter, false, array('ID', 'IBLOCK_ID', 'DESCRIPTION', 'PICTURE', 'DETAIL_PICTURE',  'UF_VIEWTYPE', 'UF_TOP_SEO'), true);
CDigital::AddMeta(
	array(
...
$arSubSections = CCache::CIblockSection_GetList(array("CACHE" => array("CACHE_GROUPS" => $arParams["CACHE_GROUPS"],"TAG" => CCache::GetIBlockCacheTag($arParams["IBLOCK_ID"]), "MULTI" => "Y")), $arSubSectionFilter, false, array("ID", "DEPTH_LEVEL"));

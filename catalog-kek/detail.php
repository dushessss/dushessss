...
$arElement = CCache::CIblockElement_GetList(array('CACHE' => array("CACHE_GROUPS" => $arParams["CACHE_GROUPS"],'TAG' => CCache::GetIBlockCacheTag($arParams['IBLOCK_ID']), 'MULTI' => 'N')), $arItemFilter, false, false, array('ID', 'PREVIEW_TEXT', 'IBLOCK_SECTION_ID', 'PREVIEW_PICTURE', 'DETAIL_PICTURE', 'PROPERTY_LINK_SALE', 'PROPERTY_LINK_SERVICES', 'PROPERTY_LINK_GOODS', 'PROPERTY_BRAND'));
